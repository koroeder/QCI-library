MODULE ADDREMOVE_IMAGES
   ...
   CONTAINS
      ...
      SUBROUTINE ADD_IMAGE(IDXMAX, ETOTAL, RMS)
         ...
         IMPLICIT NONE
         INTEGER, INTENT(IN) :: IDXMAX   !< Image gets added between IDXMAX and IDXMAX+1
