MODULE QCISETUP
   ...
   CONTAINS
      ...
      SUBROUTINE ALIGN_ENDPOINTS()
         !TODO: likely we need to define some of the variables here?
         !We need the distance for later on potentially
         USE QCIPERMDIST, ONLY: LOPERMDIST
         USE QCI_KEYS, ONLY :: NATOMS, E2E_DIST
         USE MOD_INTCOORDS, ONLY: XSTART, XFINAL

         CALL LOPERMDIST(XFINAL,XSTART,NATOMS,.FALSE.,BOXLX,BOXLY,BOXLZ,BULKT,TWOD,E2E_DIST,DIST2,RIGID,RMATBEST,0,NMOVE,NEWPERM)
