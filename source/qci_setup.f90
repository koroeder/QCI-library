MODULE QCISETUP
   ...
   CONTAINS
      SUBROUTINE QCI_INIT(PARAMETERFILE, ALIGNT)
         USE QCIKEYS, ONLY: NATOMS, QCIAMBERT, QCIFREEZET, USEIMAGEDENSITY, QCIPERMT, USEDIHEDRALCONST, QCILINEART, USELINGROUPS
         ...
         USE QCI_LINEAR, ONLY: GET_LINEAR_ATOMS, DETECT_LINEAR
