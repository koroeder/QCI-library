MODULE QCICONSTRAINTS
   ...
   CONTAINS
      ...
      SUBROUTINE CREATE_CONSTRAINTS()
         USE QCIKEYS, ONLY: NATOMS, QCIAMBERT, QCIHIRET, QCISBMT, QCIDOBACK, QCIDOBACKALL, DEBUG
         ...
         IF (DEBUG) THEN
            WRITE(*,*) "Number of constraints: ", NCONSTRAINT
            DO I=1,NCONSTRAINT
               WRITE(*,*) " CONI: ", CONI(I), " CONJ: ", CONJ(I), " CONDISTREF: ", CONDISTREF(I), " CONCUT: ", CONCUT(I)
            END DO
         END IF
