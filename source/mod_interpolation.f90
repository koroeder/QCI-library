MODULE QCIINTERPOLATION
   ...
   CONTAINS
      SUBROUTINE RUN_QCI_INTERPOLATION()
         ...
         DO WHILE (NITERDONE.LT.MAXITER)
            ...
            IF (ADDATOMT.AND.(NACTIVE.LT.NATOMS)) THEN
               ...
               ! Optional energy minimisation after we added an atom
               IF (OPTIMISEAFTERADDITION) THEN
                  ...
                  END DO
               END IF
               !end of optional minimisation after atom addition
      ...
      SUBROUTINE SET_EXIT_STATUS(NITERDONE,EXITSTATUS)
         USE CONSTR_E_GRAD, ONLY: CONVERGECONTEST, CONVERGEREPTEST, CONVERGENCEDIHTEST, FCONMAX, FREPMAX, FDIHMAX, FSPRINGMAX
